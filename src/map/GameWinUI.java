...
public class GameWinUI extends MapUI {
	...
	public GameWinUI(int s1, int s2) {
		this.s1=s1;
		this.s2=s2;
		this.setScore(s1, s2);
	...
	public void addTitleImage(int x,int y) {
		ImageIcon pic=new ImageIcon("./src/img/over/gamewin.png");
		pic=new ImageIcon(pic.getImage().getScaledInstance(550, 200,Image.SCALE_DEFAULT));
		JLabel title=new JLabel();
		title.setBounds(x,y,550,200);
		title.setIcon(pic);
